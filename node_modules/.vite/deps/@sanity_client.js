...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-2HWIEGQO.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-PQSP2VVP.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events() {
    ...
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-PQSP2VVP.js")).default : EventSource;
        if (unsubscribed)
          return;
